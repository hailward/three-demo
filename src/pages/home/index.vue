<template>
  ...
  <div class="status">
    ...
    <div>
      <p>Camera rotation</p>
      <p>
        rotationX: {{ ((cameraRef.rotation.x / Math.PI) * 180).toFixed(0) }}°
      </p>
      <p>
        rotationY: {{ ((cameraRef.rotation.y / Math.PI) * 180).toFixed(0) }}°
      </p>
      <p>
        rotationZ: {{ ((cameraRef.rotation.z / Math.PI) * 180).toFixed(0) }}°
      </p>
    </div>
  </div>
</template>
